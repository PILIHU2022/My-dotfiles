...
hl.env("QT_QPA_PLATDORM", "wayland, xcb")
hl.env("QT_AUTO_SCREEN_SCALE_FACTOR", "1")

-- GTK
hl.env("GDK_SCALE", "1")
hl.env("GDK_DPI_SCALE", "1")
hl.env("XCURSOR_THEME", "Breeze (Plasma 5)")
...
-- 将当前窗口发送到特殊工作区
hl.bind(mainMod .. "+ ALT + grave", hl.dsp.window.move({ workspace = "special:magic" }))
-- 显示和隐藏特殊工作区
